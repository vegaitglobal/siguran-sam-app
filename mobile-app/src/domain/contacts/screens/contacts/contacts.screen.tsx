...
import { BottomTabsParamList, Contact, RootStackParamList } from '@/shared/types';
...
const ContactsScreen = () => {
  ...
  // TODO: optimise
  function expoContactsToSimpleContacts(expoContacts: Contacts.Contact[]): Contact[] {
  ...
  return (
    <ScreenTemplate>
      <Header hideLeftComponent title='Moji brojevi' />
      <ScreenContent>
        <ContactsScreenTabs />
        <ContactPickerScreen
